...
#define DRM_FORMAT_MOD_SAMSUNG_SAJC(blk_size,sw_mode,addr_mode) fourcc_mod_code(SAMSUNG, (SAJC_IDENTIFIER | SAJC_BLK_SIZE_SET(blk_size) | SAJC_MOD_SW_MODE_SET(sw_mode) | SAJC_MOD_ADDRESS_MODE_SET(addr_mode)))
